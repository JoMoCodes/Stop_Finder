# Apartment course: visual & UX review

A structured review of `apartment-mockup.html` (the 3D apartment-number course),
produced in three passes and then implemented.
...
sound, backend features and new dependencies were deliberately kept out.
